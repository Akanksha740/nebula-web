        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-text-muted text-sm max-w-xs leading-relaxed">
              Historical order book data for Polymarket BTC Up/Down markets. Built for quants, researchers, and bot developers.
            </p>
            <div className="flex items-center gap-3 mt-4">
              ...
              <a href="mailto:contact@polyhistorical.com" className="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="mailto:contact@polyhistorical.com" className="text-text-muted hover:text-white text-sm transition-colors">Contact</a></li>
