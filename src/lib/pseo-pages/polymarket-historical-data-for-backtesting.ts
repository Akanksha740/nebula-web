...
const page: PseoPageFull = {
  ...
  content: `<h1>Polymarket Historical Data for Backtesting: Step-by-Step Guide</h1>
  <p>This guide walks you through using <strong>Polymarket historical data for backtesting</strong> your prediction market strategies from scratch. PolyHistorical provides all the data you need — for free.</p>
  ...
  <p>PolyHistorical covers Polymarket's BTC Up/Down markets (ETH coming soon) across multiple timeframes:</p>
  <ul>
